...
import { renderRuntime } from "./views/runtime.ts";
    ...
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${
          state.tab === "overview"
            ? renderOverview({
                ...
                pendingDevices: state.devicesList?.pending ?? [],
                ...
                onOpenRuntimePanel: (panel) => {
                  state.setRuntimePanel(panel, { replace: true });
                  state.setTab("runtime");
                },
        ...
        ${
          state.tab === "runtime"
            ? renderRuntime({
                panel: state.runtimePanel,
                presenceCount,
                sessionsCount,
                onPanelChange: (panel) => state.setRuntimePanel(panel, { replace: true }),
                onOpenChannels: () => state.setTab("channels"),
                onOpenChat: () => state.setTab("chat"),
                instances: instancesTabProps,
                sessions: sessionsTabProps,
              })
            : nothing
        }
