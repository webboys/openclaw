...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    runtime: "Visao unificada do runtime para instancias ativas e sessoes em andamento.",
    ...
    skills: "Gerenciar registro de habilidades e injecao de chaves de API.",
  ...
  languages: {
    en: "English",
    zhCN: "Chinese (Chinês Simplificado)",
