...
const CLIENT_ID =
  process.env.OPENCLAW_GOOGLE_ANTIGRAVITY_CLIENT_ID ?? "YOUR_GOOGLE_OAUTH_CLIENT_ID";
const CLIENT_SECRET =
  process.env.OPENCLAW_GOOGLE_ANTIGRAVITY_CLIENT_SECRET ?? "YOUR_GOOGLE_OAUTH_CLIENT_SECRET";
